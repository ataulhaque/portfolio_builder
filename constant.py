...
edu = [['B.Tech','IT','2011','GITA, Bhubaneswar'],['12th','Science','2006','BEMS, Belpahar'],['10th','Science','2004','DAVPS Bandhbahal']]

info = {'name':'Ataul Haque', 'Brief':'Associate Consultant at [TCS](https://tcs.com/) with 10+ years of professional experience looking out to solve complex business problems; Experienced in developing end to end feature rich deployable products in BFSI domain; Love to learn new things. Working on GenAI usecases at TCS right now !! ','photo':{'path':'abc.jpg','width':150}, 'Mobile':'9953112091','Email':'atauldilse@gmail.com','Medium':'https://medium.com/@atauldilse','City':'Bengaluru, Karnataka','Stackoverflow_flair':'''<a href="https://stackoverflow.com/users/4569149/ataul-haque"><img src="https://lh5.googleusercontent.com/-D55EVhSi3Dg/AAAAAAAAAAI/AAAAAAAAXGg/WgAOsaeG-2Y/photo.jpg?sz=256" width="150" height="80"  alt="profile for Ataul Haque at Stack Overflow, Q&amp;A for professional and enthusiast programmers" title="profile for Ataul Haque at Stack Overflow, Q&amp;A for professional and enthusiast programmers"></a>''','edu':pd.DataFrame(edu,columns=['Qualification','Stream','Year','Institute']),'skills':['Python','Perl','Unix Shell Scripting','Generative AI','AI-ML','Vertex-AI','Jenkins','React','NextJS','Git','Jupyter Notebook','Colaboratory','Streamlit','PySpark','Tensorflow','Langchain','GenAI'],'achievements':['GenAI writer @ Blogger with 20+ blogs', 'Founder of [Bhadaas.app](https://bhadaas.app/feed) — A Safe Space to record and share your thoughts Anonymously']}
