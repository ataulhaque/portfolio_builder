...
edu = [['B.Tech','IT','2011','GITA Bhubaneswar','7.25 CGPA'],['12th','Science','2006','BEMS, Belpahar', '67.2%'],['10th','-','2004','DAVPS Bandhbahal','82%']]

info = {'name':'Ataul Haque', 'Brief':'Associate Consultant @TCS with 10+ years of professional experience looking out to solve complex business problems using AI; Experienced in developing end to end feature rich deployable products for healthcare providers; Love to learn new things. Working on GenAI usecases at TCS right now !! ','photo':{'path':'abc.jpg','width':150}, 'Mobile':'9953112091','Email':'atauldisle@gmail.com','Medium':'https://namasteindia.info/p/about-us.html','City':'Bengaluru, Karnataka','Stackoverflow_flair':'''<a href="https://stackoverflow.com/users/4569149/ataul-haque"><img src="https://lh5.googleusercontent.com/-D55EVhSi3Dg/AAAAAAAAAAI/AAAAAAAAXGg/WgAOsaeG-2Y/photo.jpg?sz=256" width="150" height="80"  alt="profile for Ataul Haque at Stack Overflow, Q&amp;A for professional and enthusiast programmers" title="profile for Ataul Haque at Stack Overflow, Q&amp;A for professional and enthusiast programmers"></a>''','edu':pd.DataFrame(edu,columns=['Qualification','Stream','Year','Institute','Score']),'skills':['Python','Perl','Unix Shell Scripting','Generative AI','MongoDb','AI-ML','Vertex-AI','Jenkins','TeamCity','Git','Perforce','Jupyter Notebook','Colaboratory','SVN','Streamlit','PySpark','Tensorflow','Langchain','GenAI'],'achievements':['GenAI writer @ Blogger with 10+ blogs', 'Founder member of ITUAIEI - A Union for IT Professionals in India']}
